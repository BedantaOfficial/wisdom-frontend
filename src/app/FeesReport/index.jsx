...
const FeesReport = () => {
  ...
  const fetchPaymentsByDateRange = async () => {
    ...
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_BASE_URL}/api/v1/payments?start_date=${startDate}&end_date=${endDate}`,
        {
          headers: {
            "X-Auth-Token": token,
          },
  ...
  return (
    <div className="container">
      ...
      {showDatePicker && <div className="row mb-3">
        <div className="col">
          <input
            type="date"
      ...
      <div className="student-list">
        {
          currentState == 0 && <div className="error-message">No Records Found</div>
        }
        {
